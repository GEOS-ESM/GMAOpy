...
#   ----------
    ...
    ga('set lon -40 220') # restrict longitude to [140W,40W]
...
#   ---------
    ...
    ga('set lon 0 360')
    ga('set lat 20 50')
    ga('set lev 500')        # range of levels
    h = ga.expr('h')  # by default global lat/lon domain
    print(h.shape)
    print_stats('H XY',h) # notice scaling
